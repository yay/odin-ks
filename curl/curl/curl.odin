...
foreign libcurl {
    ...
    multi_wait                                  :: proc(multi_handle : rawptr, extra_fds : ^waitfd, extra_nfds : c.uint, timeout_ms : int, ret : ^int) -> CURLMcode ---
    multi_poll                                  :: proc(multi_handle : rawptr, extra_fds : ^waitfd, extra_nfds : c.uint, timeout_ms : int, ret : ^int) -> CURLMcode ---
